...
public class BANK7_OhMyDestiny_AFTER {
...
//	public static String temp_pass="";
	...
	//////////////////////////////////////////////////////////////////////////////
	public static int checkUrInfo(String[][] users) {
		Scanner scanner = new Scanner(System.in);
		...
		return -1;		
	}//리턴값 int, 메소드명 checkUrInfo, 파라미터 String[][] users
	
	//빈칸 찾는 것, "" 비어있으면 정보 삽입 return i, 아니면 돌아감
	public static int isNullThere(String[][] users) {
		for(int i=0; i<users.length; i++) {
			if(users[i][0].equals("")) { return i; }
		}
		return -1;
	}//리턴값 int, 메소드명 isNullThere, 파라미터 String[][] users
	
	//1. 추가기능
	public static void input(String[][] users) {
		Scanner scanner = new Scanner(System.in);
		int find = -1;
		find = isNullThere(users);
