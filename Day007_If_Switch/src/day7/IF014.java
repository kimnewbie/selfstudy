...
*/
		...
		//GIGO
		//변수
		String num, result, lv1, lv2, lv3, janghak;
		int lev = 0;
		String ch1 = "", ch2 = "", ch3 = "";
		...
		if(kor >= 90) {lv1 ="수";}
		else if(80<=kor) {lv1 ="우";}
		else if(70<=kor){lv1 ="미";}
		else if(60<=kor){lv1 ="양";}
		else { lv1 = "가";}
		
		if(eng >= 90) {lv2 ="수";}
		else if(80<=eng) {lv2 ="우";}
		else if(70<=eng){lv2 ="미";}
		else if(60<=eng){lv2 ="양";}
		else { lv2 = "가";}
		
		if(math >= 90) {lv3 ="수";}
		else if(80<=math) {lv3 ="우";}
		else if(70<=math){lv3 ="미";}
		else if(60<=math){lv3 ="양";}
		else { lv3 = "가";}
	...
	"==========================================================================");
	System.out.println(num + "\t" + kor+ "(" + lv1 + ")" + "\t" + eng+  "(" + lv2 + ")"+ "\t" 
						+ math+ "(" + lv3 + ")"+ "\t" + total+ "\t" + String.format("%.2f",avg) + "\t" 
						+ result + "\t"+ janghak + "\t" + "Lv" + lev);
	System.out.println("==========================================================================");
	System.out.println("재시험여부 "+ ch1 + "\t" + ch2 + "\t" + ch3 );
	System.out.println("==========================================================================");
